...
-- --------------------------------------------------
-- Date Created: 01/15/2022 16:30:59
...
GO
IF OBJECT_ID(N'[dbo].[FK_DeleveryManDelivery]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Deliveries] DROP CONSTRAINT [FK_DeleveryManDelivery];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_DeleveryMan_inherits_User]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Users_DeleveryMan] DROP CONSTRAINT [FK_DeleveryMan_inherits_User];
GO
...
GO
IF OBJECT_ID(N'[dbo].[Users_DeleveryMan]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Users_DeleveryMan];
GO
